...
class IndexCategoryRequestTest extends BootstrapTableTestCase
{
    ...
    public function validation_pass_for_valid_data()
    {
        ...
        $this->runValidationTest($data, IndexCategoryRequest::class);
    }
    ...
    public function validation_fails_if_searchable_is_not_exists()
    {
        ...
        $this->expectValidationException($data, IndexCategoryRequest::class);
    }
    ...
    {
        $data = [
            'searchable' => 'id,name,slug', // Should be an array
            'offset' => 0,
            'limit' => 10,
            'sort' => 'id',
            'order' => 'asc',
